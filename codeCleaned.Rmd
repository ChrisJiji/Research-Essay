...
for(r in 1:R){
  ...
  effs_10[r] <- effest
  ns_10[r] <- 2*(qlnorm(0.975, mu_param,sd_param) + qlnorm(0.8, mu_param, sd_param))^2 * pooled_variance(test)/ effest^2
}
...
for(r in 1:R){
  ...
  effest <- 2*sqrt(eta2/(1-eta2))
  effs_25[r] <- effest
  ns_25[r] <- 2*(qlnorm(0.975, mu_param,sd_param) + qlnorm(0.8, mu_param, sd_param))^2 * pooled_variance(test)/ effest^2
}
...
for(r in 1:R){
  ...
  effest <- 2*sqrt(eta2/(1-eta2))
  effs_50[r] <- effest
  ns_50[r] <- 2*(qlnorm(0.975, mu_param,sd_param) + qlnorm(0.8, mu_param, sd_param))^2 * pooled_variance(test)/ effest^2
}
...
ns <- data.frame(cbind(ns_10, ns_25, ns_50))
n_needed <- 2*(qlnorm(0.975, mu_param,sd_param) + qlnorm(0.8, mu_param, sd_param))^2 / d^2
